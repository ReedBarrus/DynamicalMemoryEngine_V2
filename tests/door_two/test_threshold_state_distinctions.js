...
{
    const degradedThreshold = deriveOperatorThresholdPosture(DEGRADED_REPLAY);
    const insufficientThreshold = deriveOperatorThresholdPosture(INSUFFICIENT_REPLAY);
    const unresolvedThreshold = deriveOperatorThresholdPosture(UNRESOLVED_REPLAY);
...
{
    const degradedFidelity = deriveOperatorFidelityPosture(DEGRADED_REPLAY);
    const insufficientFidelity = deriveOperatorFidelityPosture(INSUFFICIENT_REPLAY);
    const unresolvedFidelity = deriveOperatorFidelityPosture(UNRESOLVED_REPLAY);
