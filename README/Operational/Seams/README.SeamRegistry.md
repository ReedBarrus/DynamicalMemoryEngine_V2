...
- `governing_surface`: `README/Core/Regimes/Temporal/Contracts/README.IngestFloorContract.v0.md`
- `status`: `mechanized`
- `explicit_non_goals`:
  - no mutation
  - no diagnostics
...
- `governing_surface`: `README/Core/Regimes/Temporal/Contracts/README.ClockAlignFloorContract.v0.md`
- `status`: `mechanized`
- `explicit_non_goals`:
  - no mutation
  - no diagnostics
...
- `governing_surface`: `README/Core/Regimes/Temporal/Contracts/README.WindowFloorContract.v0.md`
- `status`: `mechanized`
- `explicit_non_goals`:
  - no mutation
  - no diagnostics
...
- `governing_surface`: `README/Core/Regimes/Temporal/Contracts/README.TransformFloorContract.v0.md`
- `status`: `mechanized`
- `explicit_non_goals`:
  - no mutation
  - no diagnostics
...
- `governing_surface`: `README/Core/Regimes/Temporal/Inspection/Planes/README.PlanePosture.v0.md`
- `status`: `typed`
- `explicit_non_goals`:
  - not runtime lane
...
- `owner_surface`: `README/Core/Regimes/Temporal/Execution/README.TemporalExecutionSurface.v0.md`
- `governing_surface`: `README/Core/Regimes/Temporal/Execution/README.TemporalExecutionSurface.v0.md`
- `status`: `declared`
- `explicit_non_goals`:
  - not product shell
...
- `owner_surface`: `README/Core/Regimes/Temporal/Inspection/Rendering/README.PlaneRenderer.md`
- `governing_surface`: `README/Core/Regimes/Temporal/Inspection/Rendering/README.PlaneRenderer.md`
- `status`: `declared`
- `explicit_non_goals`:
