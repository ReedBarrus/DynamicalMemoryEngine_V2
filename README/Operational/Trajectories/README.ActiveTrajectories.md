...
- the live developmental-outline path in this workspace is `README/Constitution/Workflow/README.DevelopmentPressure.md`
- a standalone `README.ActiveLawKernel.md` is not present in the current workspace, so active-law-kernel posture is taken from current workflow notes and `AGENTS.md` without creating a new authority note here
